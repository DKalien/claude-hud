...
export type HudElement = 'project' | 'addedDirs' | 'context' | 'usage' | 'promptCache' | 'memory' | 'environment' | 'mimo' | 'tools' | 'skills' | 'mcp' | 'agents' | 'todos' | 'sessionTime' | 'sessionTokens' | 'compactions';
